...
const FollowingIcon = ({ className, viewBox, color, ...rest }) => {
  const classes = useStyles();

  return (
    <SvgIcon viewBox={viewBox || "0 0 16 14"} {...rest} className={clsx(classes.root, className)} >
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
        <g id="Follow_bttn" transform="translate(-45.000000, -112.000000)" stroke="#FFFFFF" strokeWidth="1.27272727">
          <g id="Follow" transform="translate(30.000000, 101.000000)">
            <g id="Button">
              <g id="heart" transform="translate(16.000000, 12.000000)">
